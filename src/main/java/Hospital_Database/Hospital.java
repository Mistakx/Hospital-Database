...
public class Hospital {
    ...
    private Hospital(String hospitalDatabaseFilePath, Scanner scanner) {
        Files.readAndParseFile(hospitalDatabaseFilePath);
        this.scannerObject = scanner;
    }

    public static Hospital getInstance(String hospitalDatabaseFilePath, Scanner scanner) {
        if (INSTANCE == null) {
            INSTANCE = new Hospital(hospitalDatabaseFilePath, scanner);
        }
    ...
    public void administratorMenuUserInterface() {
                    ...
                    case 2:
                        ...
                        for (Person tempPerson : people) {
                            if (personID == tempPerson.getID()) {
                                personExists = true;
                                Medic newMedic = new Medic(personID, tempPerson.getName(),
                                        tempPerson.getBirthdayYear());
                        ...
                        if (!personExists) {
                            System.out.println("A pessoa introduzida não existe.");
                        }
                        break;
    ...
    public void promoteSpecialistNurseToChief() {
    ...
    public void listPacientsInHospitalQueue() {
        // TODO
    }

    public void trashRequestsForAuxiliaryNurses() {
        // TODO
    }
